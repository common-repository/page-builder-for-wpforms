...
use rnpagebuilder\PageGenerator\Core\QueryBuilder\Comparison\ComparisonFormatter\StringComparisonFormatter;
    ...
    public function CreateComparisonString($leftSide, $rightSide)
    {
        ...
        switch ($this->Comparison)
        {
            ...
            case 'HasNotRole':
                ...
                $userMetaDependency->Comparisons[]=new ColumnComparison($this->FilterLine->FilterGroup->QueryBuilder->RootID,'user_id','Equal','usermeta','user_id');
            ...
            default:
                throw new FriendlyException('Invalid comparison type '.$this->Comparison,'Invalid comparison type '.$this->Comparison,ExceptionSeverity::$FATAL);
