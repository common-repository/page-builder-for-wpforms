...
use rnpagebuilder\PageBuilderOld\QueryBuilder\Comparison\ComparisonFormatter\NumericComparisonFormatter;
use rnpagebuilder\PageBuilderOld\QueryBuilder\Comparison\DateFixedValueComparison;
use rnpagebuilder\PageBuilderOld\QueryBuilder\Comparison\EntryIdValueComparison;
use rnpagebuilder\PageBuilderOld\QueryBuilder\Comparison\FixedValueComparison;
use rnpagebuilder\PageBuilderOld\QueryBuilder\Comparison\ListFixedValueComparison;
use rnpagebuilder\PageBuilderOld\QueryBuilder\Comparison\UserValueComparison;
...
use rnpagebuilder\PageBuilderOld\QueryBuilder\Filters\MultipleGroupFilter;
use rnpagebuilder\PageBuilderOld\QueryBuilder\QueryBuilder;
...
class FormDataSource extends DataSourceBase
{
    ...
    {
        $queryBuilder=new QueryBuilder($this->PageBuilder->Loader, $this->PageBuilder->Loader->WPFormRecordTable,'ROOT');
        ...
        $column->AddColumn2('ROOT','entry_id',$this->Options->Id.'_EntryId');
    ...
    private function GenerateQueryElements($queryBuilder, $filterGroup,$conditionLine)
    {
        ...
        switch ($conditionLine->FieldId)
        {
            ...
            default:
                ...
                $dependency->Comparisons[]=new ColumnComparison('ROOT','entry_id','Equal',$tableId,'entry_id');
