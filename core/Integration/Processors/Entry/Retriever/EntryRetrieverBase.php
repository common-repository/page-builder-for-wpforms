...
namespace rnpagebuilder\core\Integration\Processors\Entry\Retriever;
...
abstract class EntryRetrieverBase
{
     ...
     * @param null $raw
     * @param null $originalFields
     * @return bool
     */
    public function InitializeByEntryItems($entryItems,$raw=null,$originalFields=null)
    {
